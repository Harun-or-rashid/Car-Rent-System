...
class CarController extends Controller
{
    ...
    {
        $cars = Car::with('category', 'user', 'car_type')->where(['status'=>'1', 'user_id'=>Auth::id()])->get();
        return view('carOwner.cars.all_cars', compact('cars'));
    }
    ...
    public function create()
    {
        ...
        return view('carOwner.cars.add_new_car', compact('categories', 'car_types'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($addCar == true) {
                ...
                return redirect()->route('carOwner.cars.index', compact('cars'));
            } else {
    ...
    public function edit($id)
    {
        ...
        if ($carDetail) {
            $categories = Category::all();
            $car_types = CarType::all();
            return view('carOwner.cars.edit_car', compact('carDetail', 'categories', 'car_types'));
